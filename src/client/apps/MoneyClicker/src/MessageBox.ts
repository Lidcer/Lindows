export class MSG {
    ...
    //Element Aligner
    private box(): void {
        let x = this.canvas.width * (this.screenCoverAnimation / 100);
    ...
    private clickButton0(x: number, y: number): void {
        let a = this.buttonPos0[0] < x;
        let b = this.buttonPos0[1] < y;
        let c = this.buttonPos0[0] + this.buttonPos0[2] > x;
        let d = this.buttonPos0[1] + this.buttonPos0[3] > y;
    ...
    private clickButton1(x: number, y: number): void {
        let a = this.buttonPos1[0] < x;
        let b = this.buttonPos1[1] < y;
        let c = this.buttonPos1[0] + this.buttonPos1[2] > x;
        let d = this.buttonPos1[1] + this.buttonPos1[3] > y;
    ...
    private clickButton2(x: number, y: number): void {
        let a = this.buttonPos2[0] < x;
        let b = this.buttonPos2[1] < y;
        let c = this.buttonPos2[0] + this.buttonPos2[2] > x;
        let d = this.buttonPos2[1] + this.buttonPos2[3] > y;
    ...
    private buttons(): void {
        switch (this.button) {
            ...
            case 2:
                let c = 1 / 3 - 0.0333333333;
                this.buttonPos0[0] = this.imagePos[0] + this.imagePos[2] * 0.025;
                this.buttonPos0[1] = this.imagePos[1] + this.imagePos[3] * 0.75;
                this.buttonPos0[2] = this.imagePos[2] * c;
                this.buttonPos0[3] = this.imagePos[3] * 0.2;

                this.buttonPos1[0] = this.imagePos[0] + this.imagePos[2] * (c + 0.050);
                this.buttonPos1[1] = this.imagePos[1] + this.imagePos[3] * 0.75;
            ...
            default:
                ...
                this.buttonPos0[3] = this.imagePos[3] * 0.20;
    ...
    private text(): void {
        ...
        this.textSize = this.imagePos[3] * 0.10;
